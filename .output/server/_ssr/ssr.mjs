...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CkJWZm3s.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-GYMw99Z6.mjs"),
		import("./start-vaf6T3jt.mjs"),
...
//#endregion
export { ssr_exports as i, createStart as n, getGlobalStartContext as r, createMiddleware as t };
